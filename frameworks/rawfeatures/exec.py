...
from fastsklearnfeature.feature_selection.RawFeatureScikit import RawFeatureScikit
...
def run(dataset: Dataset, config: TaskConfig):
    ...
    fe = RawFeatureScikit(max_time_secs=config.max_runtime_seconds,
                          scoring=scoring_metric,
                          model=model,
                          parameter_grid=parameter_grid,
                          n_jobs=n_jobs,
                          feature_names=names,
                          feature_is_categorical=is_categorical)
